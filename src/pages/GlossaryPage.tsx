...
const NAVIGATION_HELP = [
  ...
  {
    title: 'Les votes',
    body: "La flamme en haut d'une ligne vote pour une playlist, un vote par personne et par playlist. Le total s'affiche à côté et se voit de tout le monde, y compris sans compte. En revanche personne ne peut savoir qui a voté quoi : le lien entre une personne et son vote n'est lisible par personne d'autre qu'elle, et c'est la base de données qui le refuse, pas seulement l'affichage. « Les plus votées », au-dessus de la liste, range par ce total ; l'enlever rend l'ordre habituel, du plus chill au plus NRV.",
  },
  {
    title: 'Ouvrir une playlist',
    body: "Un clic n'importe où sur une ligne ouvre la playlist dans Spotify — sauf sur un tag, sur le signet ou sur la flamme de vote, qui font ce qu'ils disent.",
  },
]
